...
namespace hhs_p6_webshop_project.Controllers.ProductsController
{
    public class ProductImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductImageId,Path,ProductTypeId")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductImageId,Path,ProductTypeId")] ProductImage productImage)
        {
